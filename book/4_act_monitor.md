...
## 🟧 TOOL 4.1 - Discussing Learning Plan Progress

_**Guiding questions to discuss progress on individual learning plans**_
...
NB: These suggestions are just for inspiration. Be creative! (and additional suggestions are welcome)!<br/><br/>
...
-   **Quiz-formats**  to support  **progress monitoring**  and facilitate  **retrieval practice:**  
    (every student prepares a few questions):  
        - Collaborative create, perform and evaluate online quiz: wooclap, etc.  
                - “De slimste mens” formats:  
                        - create puzzles from 3x4 table  
                        - “What do you know about…”  
                - Create and exchange flashcards (tip: Anki-app:  [https://www.ankiapp.com/)](https://www.ankiapp.com/))
-   Perform and evaluate  **role plays**, e.g.:  
        -  Parts of doctor-patient encounters  
...
-   STARR  **intervision** format  
        - Students interviewing each other using STARR technique (see tool A9) on experiences with learning strategies, study planning, SMART learning goals, etc.  
    
-   **“Am I the only one….”**  
        - Share experience, ask question to group, generate multiple possible solutions or alternatives together. > Student who asked question concludes and formulates key message / advice taken.

---

Resource for Flashcards: Anki-app,  [https://www.ankiapp.com/](https://www.ankiapp.com/); see also  [Study Smart, workbook session 2](https://www.studysmartpbl.com/student/workbook-werkboek/)<br/><br/>
