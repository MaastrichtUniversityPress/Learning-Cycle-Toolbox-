...
-   _Performance information plans_  for specific periods > on Canvas
    -   feedback options and opportunities and links with competencies
-   _Assessment policy Competency Exam_ > on intranet
    -   end-of-year assessment procedure details
-   _Education and Exam Regulations (EER) / Rules and Regulations (RR)_ > on intranet
    -   for BaMED curriculum overall
-   _Act-E_  > via Canvas or this  [link](https://unimaas.act-e.nl/program/2d4085a6-27e0-408a-b38d-299ac760b784/structure/overview).
    -   Overview of all BaMED APTs and POs
...
-   Review performance objectives and  **progress**  made:
    ...
    -   Are you performing as expected? What evidence supports this?
-   For  **difficult / below**  **standard**  POs:
    -   What feedback did you receive? What is the problem?
    -   How could you remediate? > Make SMART goal
-   Review  **personal learning goals**:
    -   Where are you now? To what level did you grow during this period?
    -   Are you satisfied? Did you reach the level you aimed for?
    -   How to continue with this learning goal?
        -   Finish > If aim is reached and consolidated
        -   Continue > Define next step
        -   Adapt > Reformulate learning goal
    -   Look back at  **learning process**  and  **learning strategies**:
...
-   What  **evidence**  did you collect in this period?
    -   What is new? > How did you develop in this period?
-   Review all evidence combined > search for overarching  **patterns**:
    -   What are your strengths? What are you (already) good at?
    -   What are your challenges / pitfalls / point to work on?
-   Look  **forward**:
...
-   How did you  **develop** during this academic year? Where are you now?
    -   Summarize milestones
    -   Refer to Framework Medical Education 2022
    -   Underpin your statements with evidence
-   What are your  **strong points**?
    -   How do these help you? How can you utilize them? How do they define you as a student/doctor?
-   What are your  **challenges / pitfalls**?
    -   How do these hinder you? How could you change/improve? What is their impact on you as a student/doctor?
-   Look  **forward**:
...
Check the following activities to collectively support portfolio work. Also explore the suggested reflective activities to gain inspiration for topics and themes for evaluation, team reflection, and group discussions.
...
-   Intervision: Competence cards writing
    -   Time for questions and advice on the art of competence card writing
...
-   STARR interviewing
-   Incident method
-   Question cards: prepare generic question cards before meeting, during session draw cards and answer:
    -   How do you feel about…
    -   What is your favorite…. and why
    -   …
-   Use photographs / “association cards” to trigger spontaneous associations
    -   Team roles: what animal are you?
